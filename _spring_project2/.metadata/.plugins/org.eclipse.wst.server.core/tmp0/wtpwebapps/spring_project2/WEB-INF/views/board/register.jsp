...
<div class="container">
  <main>
	...
	<!-- 현재 인증한 사용자의 정보를 가져오는 태그입니다. 
	스프링 Security 구조대로 짰다면 손쉽게 태그를 이용해 가져올 수 있습니다. 
...
<sec:authentication property="principal.mvo.email" var="authEmail"/>
    ...
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="/resources/image/icons-hero.png" alt="" width="100" height="80">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                ...
                id="writer" value="${authEmail }" placeholder="Writer">              
              </div>
            </div>
